package br.com.itau.recuperacao.cobranca.infrastructure.config;
...
/**
 * Configuração do Apache Kafka para o serviço de cobrança.
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "cobranca-service");
